...
import { useLocalizedStrings } from "@applicaster/zapp-react-native-utils/localizationUtils";
  ...
  import { useInitialFocus, useFocusManager } from "@applicaster/zapp-react-native-utils/focusManager";
...
//   const screenLayout = React.useContext(ScreenLayoutContext);
  ...
  const [initialFocusable, setInitialFocusable] = React.useState(login1ButtonRef);
  ...
  React.useEffect(() => {
    focused && setInitialFocusable(login1ButtonRef);
  }, [focused]);
